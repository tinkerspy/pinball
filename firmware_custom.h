...
char game_symbols[] = {
  "IN_GAME_INIT, IN_GAME_PRESS, IN_GAME_RELEASE, SUB_GAME_WAIT_PLAYERS, SUB_GAME_WAIT_RESET, SUB_GAME_LOOP,"
    "SUB_GAME_BALL_LOOP, SUB_GAME_PLAYER_LOOP, SUB_GAME_CORE, SUB_GAME_WAIT_PLAYING, SUB_GAME_WAIT_COLLECTING\n"
  "OUT_GAME_INIT, OUT_GAME_ENABLE, OUT_GAME_COUNTER_RESET, OUT_GAME_PLAYERS_ZERO, OUT_GAME_BALL_ZERO,"
    "OUT_GAME_PLAYER_ZERO, OUT_GAME_BALL_ADV, OUT_GAME_PLAYER_ADV, OUT_GAME_3BONUS, OUT_GAME_COLLECT,"
    "OUT_GAME_KICKOFF, OUT_GAME_OVER, OUT_GAME_PLAYERS_ADV\n" 
  "ARG_GAME_ENABLED, ARG_GAME_COLLECTING, ARG_GAME_AGAIN, ARG_GAME_COUNTER0, ARG_GAME_COUNTER1," 
     "ARG_GAME_COUNTER2, ARG_GAME_COUNTER3, ARG_GAME_COUNTER4, ARG_GAME_COUNTER5\n"
  "REG_GAME_STATE, REG_GAME_MAX_PLAYERS, REG_GAME_NO_OF_PLAYERS, REG_GAME_PLAYER, REG_GAME_NO_OF_BALLS," 
      "REG_GAME_BALL, REG_GAME_BALL_CNTR\n"
};
...
char tictactoe_symbols[] = 
  "IN_OXO_INIT, IN_OXO_1O, IN_OXO_1X, IN_OXO_2O, IN_OXO_2X, IN_OXO_3O, IN_OXO_3X, IN_OXO_4, IN_OXO_5, IN_OXO_6, IN_OXO_7, IN_OXO_8, IN_OXO_9," 
    "IN_OXO_TOGGLE, IN_OXO_COLLECT, IN_OXO_SINGLE, IN_OXO_TRIPLE SUB_OXO_COLLECT, SUB_OXO_MATCH_123, SUB_OXO_MATCH_456, SUB_OXO_MATCH_789,"
    "SUB_OXO_MATCH_147, SUB_OXO_MATCH_258, SUB_OXO_MATCH_369, SUB_OXO_MATCH_159, SUB_OXO_MATCH_357, SUB_OXO_MATCH_ALL, SUB_OXO_CLEAR\n"
  "OUT_OXO_SCORE, OUT_OXO_WIN_ROW, OUT_OXO_WIN_ALL, OUT_OXO_COLLECT\n"
  "ARG_OXO_1A, ARG_OXO_1B, ARG_OXO_1C, ARG_OXO_2A, ARG_OXO_2B, ARG_OXO_2C, ARG_OXO_3A, ARG_OXO_3B, ARG_OXO_3C, ARG_OXO_4A, ARG_OXO_4B, ARG_OXO_4C,"
    "ARG_OXO_5A, ARG_OXO_5B, ARG_OXO_5C, ARG_OXO_6A, ARG_OXO_6B, ARG_OXO_6C, ARG_OXO_7A, ARG_OXO_7B, ARG_OXO_7C, ARG_OXO_8A, ARG_OXO_8B, ARG_OXO_8C,"
    "ARG_OXO_9A, ARG_OXO_9B, ARG_OXO_9C, ARG_OXO_X, ARG_OXO_O, ARG_OXO_TRIPLE, ARG_OXO_COLLECT\n";
