...
const int16_t oxo_led_matches[] = {
    0, 3, LED_OXO_1A, LED_OXO_2A, LED_OXO_3A, -1,
    0, 3, LED_OXO_1B, LED_OXO_2B, LED_OXO_3B, -1,
    0, 3, LED_OXO_4A, LED_OXO_5A, LED_OXO_6A, -1,
    0, 3, LED_OXO_4B, LED_OXO_5B, LED_OXO_6B, -1,
    0, 3, LED_OXO_7A, LED_OXO_8A, LED_OXO_9A, -1,
    0, 3, LED_OXO_7B, LED_OXO_8B, LED_OXO_9B, -1,
    0, 3, LED_OXO_1A, LED_OXO_4A, LED_OXO_7A, -1,
    0, 3, LED_OXO_1B, LED_OXO_4B, LED_OXO_7B, -1,
    0, 3, LED_OXO_2A, LED_OXO_5A, LED_OXO_8A, -1,
    0, 3, LED_OXO_2B, LED_OXO_5B, LED_OXO_8B, -1,
    0, 3, LED_OXO_3A, LED_OXO_6A, LED_OXO_9A, -1,
    0, 3, LED_OXO_3B, LED_OXO_6B, LED_OXO_9B, -1,
    0, 3, LED_OXO_1A, LED_OXO_5A, LED_OXO_9A, -1,
    0, 3, LED_OXO_1B, LED_OXO_5B, LED_OXO_9B, -1,
    0, 3, LED_OXO_3A, LED_OXO_5A, LED_OXO_7A, -1,    
    0, 3, LED_OXO_3B, LED_OXO_5B, LED_OXO_7B, -1,
    1, 9, LED_OXO_1A, LED_OXO_2A, LED_OXO_3A, LED_OXO_4A, LED_OXO_5A, LED_OXO_6A, LED_OXO_7A, LED_OXO_8A, LED_OXO_9A,
          LED_OXO_1B, LED_OXO_2B, LED_OXO_3B, LED_OXO_4B, LED_OXO_5B, LED_OXO_6B, LED_OXO_7B, LED_OXO_8B, LED_OXO_9B, -1,
    -1,    
};
